                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12" id="mainShopDiv">
                                    <div class="shop-product">
                                        <div id="myTabContent-2" class="tab-content" v-if="allProducts.length >0 && !isLoading">
                                            <div id="grid" class="tab-pane fade " :class="(thumbnail)? 'active show' : ''">
                                                <div class="product-grid-view">
                                                    <div class="row _onlymob_g_2">
                                                            ...
                                                            <div class="single-grid-product mb-30">
                                                                ...
                                                                <div class="product-content">
                                                                    <div class="product-category-rating">
                                                                        <span class="category">
                                                                            <nuxt-link  :to="{ name: 'shop', query: { categoryId: p.categoryId }}">{{p.allcategory.catName}}</nuxt-link>
                                                                        </span>
                                                                    ...
                                                                    <h3 class="title">
                                                                        <nuxt-link :to="{name:'single-product-id', params: { id:p.id } }" >{{p.productName}}  {{p.model}}</nuxt-link>
                                                                    </h3>
                                        ...
                                        <div v-else class="text-center">
                                            <h1 class="_no_pro"><span>No Product Found!</span></h1>
                                        </div>
                                        ...
                                        <div v-else-if="noProductRemaining" class="text-center">
                                          <h1  class="_no_pro"><span style="margin-left: 10px;">No More Product Found...</span></h1>
                                        </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            async loadMore(more=20){
              console.log("Load more is calling!")
                ...
                const res = await this.callApi('get',`app/salePageData?order=${this.orders}&limit=${this.limit}&groupId=${this.groupId}&categoryId=${this.categoryId}&tags=${this.tags}&str=${this.str}&minPrice=${this.minPrice}&maxPrice=${this.maxPrice}&brandId=${this.brandId}&colour=${this.colour}`)
                if(res.status == 200){
            ...
            async filterData(){
                ...
                window.history.pushState({}, null, `/sale?order=${this.orders}&page=${this.page}&groupId=${this.groupId}&categoryId=${this.categoryId}&tags=${this.tags}&str=${this.str}&minPrice=${this.minPrice}&maxPrice=${this.maxPrice}&brandId=${this.brandId}&colour=${this.colour}`);
                // this.isLoading = true;
                this.$store.commit('setGlobalProductLoading',true)
                const res = await this.callApi('get',`app/salePageData?order=${this.orders}&page=${this.page}&groupId=${this.groupId}&categoryId=${this.categoryId}&tags=${this.tags}&str=${this.str}&minPrice=${this.minPrice}&maxPrice=${this.maxPrice}&brandId=${this.brandId}&colour=${this.colour}`)
                if(res.status == 200){
        ...
        async created(){
            ...
            window.history.pushState({}, null, `/sale?order=${this.orders}&limit=${this.limit}&groupId=${this.groupId}&categoryId=${this.categoryId}&tags=${this.tags}&str=${this.str}&minPrice=${this.minPrice}&maxPrice=${this.maxPrice}&brandId=${this.brandId}&colour=${this.colour}`);
            const [res,res1,res2,res3,res4] = await Promise.all([
                this.callApi('get','app/allGroups'),
                this.callApi('get',`app/salePageData?order=${this.orders}&limit=${this.limit}&groupId=${this.groupId}&categoryId=${this.categoryId}&tags=${this.tags}&str=${this.str}&minPrice=${this.minPrice}&maxPrice=${this.maxPrice}&brandId=${this.brandId}&colour=${this.colour}`),
