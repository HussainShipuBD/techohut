...
export default {
    ...
    // },
    async mounted(){
       const res =  await this.callApi('get',`app/bkash/payment_exceute/${this.$route.query.paymentID}`)
       if(res.status == 200){
